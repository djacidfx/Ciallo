⚠️Pages and features below are under construction. Navigate to the [Contributing Tab] for the development plan.

Want to know how these features are (or will be) implemented?
Leave a star to this project and check my [research project], paper or [tutorial](https://shenciao.github.io/brush-rendering-tutorial/Introduction/).
---
# Ciallo ～(∠・ω< )⌒★!
...
Like those old days Adobe Flash was alive.

Ciallo also export the original layers as nodes to facilitate creating CG variations.
...
Ciallo uses a custom vector format that is hard to be generated by AI.
...
Do you really need this feature? Tell me how to add more supports on this.")
