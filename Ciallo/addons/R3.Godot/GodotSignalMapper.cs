...
public static class GodotObjectExtensions
{
    ...
    /// <summary>Returns an observable that: publishes a <see cref="Unit"/> when <paramref name="node"/> emits the specified signal.</summary>
    public static Observable<Unit> SignalAsObservable(this Node node, StringName signalName)
    {
        return node.SignalAsObservable(signalName, CancellationToken.None);
    }

    /// <summary>Returns an observable that: publishes data of type <typeparamref name="T"/> when <paramref name="node"/> emits the specified signal.</summary>
    public static Observable<T> SignalAsObservable<[MustBeVariant] T>(this Node node, StringName signalName)
    {
        return node.SignalAsObservable<T>(signalName, CancellationToken.None);
    }

    /// <summary>Returns an observable that: publishes a tuple (<typeparamref name="T0"/>, <typeparamref name="T1"/>) when <paramref name="node"/> emits the specified signal.</summary>
    public static Observable<(T0, T1)> SignalAsObservable<[MustBeVariant] T0, [MustBeVariant] T1>(this Node node, StringName signalName)
    {
        return node.SignalAsObservable<T0, T1>(signalName, CancellationToken.None);
    }

    /// <summary>Returns an observable that: publishes a tuple (<typeparamref name="T0"/>, <typeparamref name="T1"/>, <typeparamref name="T2"/>) when <paramref name="node"/> emits the specified signal.</summary>
    ...
    {
        return node.SignalAsObservable<T0, T1, T2>(signalName, CancellationToken.None);
    }

    /// <summary>Returns an observable that: publishes a tuple (<typeparamref name="T0"/>, <typeparamref name="T1"/>, <typeparamref name="T2"/>, <typeparamref name="T3"/>) when <paramref name="node"/> emits the specified signal.</summary>
    ...
    {
        return node.SignalAsObservable<T0, T1, T2, T3>(signalName, CancellationToken.None);
    }

    /// <summary>Returns an observable that: publishes a tuple (<typeparamref name="T0"/>, <typeparamref name="T1"/>, <typeparamref name="T2"/>, <typeparamref name="T3"/>, <typeparamref name="T4"/>) when <paramref name="node"/> emits the specified signal.</summary>
    ...
    {
        return node.SignalAsObservable<T0, T1, T2, T3, T4>(signalName, CancellationToken.None);
    }

    /// <summary>Returns an observable that: publishes a tuple (<typeparamref name="T0"/>, <typeparamref name="T1"/>, <typeparamref name="T2"/>, <typeparamref name="T3"/>, <typeparamref name="T4"/>, <typeparamref name="T5"/>) when <paramref name="node"/> emits the specified signal.</summary>
    ...
    {
        return node.SignalAsObservable<T0, T1, T2, T3, T4, T5>(signalName, CancellationToken.None);
    }

    /// <summary>Returns an observable that: publishes a tuple (<typeparamref name="T0"/>, <typeparamref name="T1"/>, <typeparamref name="T2"/>, <typeparamref name="T3"/>, <typeparamref name="T4"/>, <typeparamref name="T5"/>, <typeparamref name="T6"/>) when <paramref name="node"/> emits the specified signal.</summary>
    ...
    {
        return node.SignalAsObservable<T0, T1, T2, T3, T4, T5, T6>(signalName, CancellationToken.None);
    }

    /// <summary>Returns an observable that: publishes a tuple (<typeparamref name="T0"/>, <typeparamref name="T1"/>, <typeparamref name="T2"/>, <typeparamref name="T3"/>, <typeparamref name="T4"/>, <typeparamref name="T5"/>, <typeparamref name="T6"/>, <typeparamref name="T7"/>) when <paramref name="node"/> emits the specified signal.</summary>
    ...
    {
        return node.SignalAsObservable<T0, T1, T2, T3, T4, T5, T6, T7>(signalName, CancellationToken.None);
    }

    /// <summary>Returns an observable that: publishes a tuple (<typeparamref name="T0"/>, <typeparamref name="T1"/>, <typeparamref name="T2"/>, <typeparamref name="T3"/>, <typeparamref name="T4"/>, <typeparamref name="T5"/>, <typeparamref name="T6"/>, <typeparamref name="T7"/>, <typeparamref name="T8"/>) when <paramref name="node"/> emits the specified signal.</summary>
    ...
    {
        return node.SignalAsObservable<T0, T1, T2, T3, T4, T5, T6, T7, T8>(signalName, CancellationToken.None);
    }
