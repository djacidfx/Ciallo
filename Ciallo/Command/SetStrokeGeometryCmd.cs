...
public class SetStrokeGeometryCmd : CommandBase
{
    ...
    public override void Do()
    {
        ...
        // Overlay
        _strokeE.Get<PolylineWireframe>().SetGeometry(_newGeometry.Points, _newGeometry.Radii);
    ...
    public override void Undo()
    {
        ...
        // Overlay
        _strokeE.Get<PolylineWireframe>().SetGeometry(_oldGeometry.Points, _oldGeometry.Radii);
